...
const { userRegisterValidation, uploadVideoValidation, projectNameValidation } = require('../validation/validateFunction');
...
router.post('/project-name', projectNameValidation, createProject);
